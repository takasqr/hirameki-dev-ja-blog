...
describe('isCloudinary', () => {
  it('正常系', () => {
    ...
    const expectedUrl = 'https://image.hirameki.dev/takasqr/image/upload/l_text:MPLUS1p-Black.ttf_70_bold:2025年は%0A文章をたくさん%0A書きたい,co_rgb:fff,w_620,c_fit/w_250/cover_2025_rpwog8.png'
