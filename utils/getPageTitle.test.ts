...
describe('getPageTitle', () => {
  it('タイトルがサイトタイトルと異なる場合、結合して返す', () => {
    expect(getPageTitle('記事のタイトル', '/p/')).toBe('記事のタイトル | HIRAMEKI.DEV');
